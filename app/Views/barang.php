            ...
            <div class="col">
                <div class="card">
                        ...
                        <div class="row align-items-center">
                            ...
                            <?php if (in_groups('superadmin')) : ?>
                                <div class="col-4 text-right">
                                    <a href="/barang/tambah" class="btn btn-sm btn-primary"><i class="ni ni-fat-add"></i> Tambah Barang</a>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                                            ...
                                            <td class="text-right">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                        <a class="dropdown-item" href="/barang/hapus/<?= $brg['kode_barang']; ?>" onclick="return confirm('Anda yakin ingin mengapus?')">Hapus</a>
                                                        <a class="dropdown-item" href="/barang/edit/<?= $brg['kode_barang']; ?>">Edit</a>
                                                    </div>
                                                </div>
                                            </td>
                                        <?php endif; ?>
                    ...
                    <div class="card-footer py-4">
                        <nav aria-label="...">
                            <?= $pager->links('brg', 'pagination_custom'); ?>
                        </nav>
                    </div>
                </div>
            </div>
