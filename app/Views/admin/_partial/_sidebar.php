    ...
    <div class="scrollbar-inner">
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link <?= (current_url() == base_url('/admin')) ? 'active' : '' ?>" href="/">
          ...
          <ul class="navbar-nav mb-md-3">
            <li class="nav-item">
              <a class="nav-link <?= (current_url() == base_url('admin/barang/')) ? 'active' : '' ?>" href="/admin/barang">
            ...
            <?php if (in_groups('superadmin')) : ?>
              <li class="nav-item">
                <a class="nav-link <?= (current_url() == base_url('admin/peminjam/')) ? 'active' : '' ?>" href="/admin/peminjam">
            ...
            <?php endif; ?>
            <li class="nav-item">
              <a class="nav-link <?= (current_url() == base_url('admin/pinjam/')) ? 'active' : '' ?>" href="/admin/pinjam">
          ...
          <ul class="navbar-nav mb-md-3">
            <li class="nav-item">
              <a class="nav-link <?= (current_url() == base_url('admin/lappmj/')) ? 'active' : '' ?>" href="/admin/lappmj/">
                <i class=" ni ni-basket text-primary"></i>
                <span class="nav-link-text">Laporan Peminjaman</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link <?= (current_url() == base_url('admin/lappeng/')) ? 'active' : '' ?>" href="/admin/lappmb/">
